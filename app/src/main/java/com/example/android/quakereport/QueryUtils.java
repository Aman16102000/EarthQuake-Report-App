    ...
    public static ArrayList<earthquake> extractEarthquakes() {
        ...
        try {
            ...
            for(int i=0;i<jsonArray.length();i++)
            {
                ...
                JSONObject jsonObjectprop=jsonObject.getJSONObject("properties");
               /* int mag= Integer.parseInt(jsonObjectprop.optString("mag").toString());
                String place=jsonObjectprop.getString("place");
                int time=Integer.parseInt(jsonObjectprop.getString("time").toString());*/
